 ...
 *   1 Spegel:  blicklinje (314, 672) → (302, 696), avslutad med tvärstreck.
 *     Cyklistens närmaste hörn är (285, 746); avståndet från linjens slut är
 *     √(17² + 50²) ≈ 53 px — spegeln tar slut långt innan cyklisten. ✔
 *   2 Tecken:  vänsterblinkers vid karossens bakre vänstra hörn, (318, 704),
 *     trianglen x 312–318, blinkstrecken x 305–309 vid y 701 och 707.
 *     Spegellinjen är slut vid y 696 och rör dem alltså inte.
 ...
 *     y-intervallen alls: spegeln slutar y 696, axelblicken börjar y 722.
 ...
 *   V3: (150,668)→(300,698), (150,734)→(310,706), (186,790)→(267,752)
 *       y-band 668–698 / 706–734 / 752–790 — parvis åtskilda. Nr 1 slutar på
 *       x 300 och nr 2 passerar x 302 först vid y 707, alltså under spegellinjens
 *       slut (y 696) — de korsar varken varandra eller spegellinjen. Ingen av dem
...
function Cyclist({ cx, cy }: { cx: number; cy: number }) {
  return (
    <g transform={`translate(${cx} ${cy})`}>
      ...
      <rect x="-7" y="-10" width="14" height="20" rx="5" fill="url(#sr-cross)" className="stroke-safety-600" strokeWidth="2" />
      <line x1="-8" y1="-6" x2="8" y2="-6" className="stroke-text-primary" strokeWidth="2.5" strokeLinecap="round" />
      <circle cx="0" cy="-1" r="3.6" className="fill-diagram-marking stroke-text-primary" strokeWidth="1.5" />
    </g>
  );
}
...
function MiniByte({ x, y, variant }: { x: number; y: number; variant: 'axelblick' | 'utan' }) {
  ...
  return (
    <g transform={`translate(${x} ${y}) scale(0.45)`}>
      ...
      {!ok && (
        <rect x="-56" y="10" width="56" height="44" fill="url(#sr-hatch)" className="stroke-safety-600" strokeWidth="2" />
      )}
      ...
      <Cyclist cx={-28} cy={70} />
      <Car cx={28} cy={20} width={26} length={44} fill="url(#sr-dots)" stroke="stroke-attention-600" />
...
export function SpegelrutinDiagram() {
  return (
    <svg viewBox="0 0 440 1174" className="w-full max-w-md mx-auto" role="img" aria-labelledby="sr-title sr-desc">
      ...
      <desc id="sr-desc">
        ...
        riktning, all trafik uppåt i bilden. Elevens bil, fylld med prickmönster, ligger i det
        högra körfältet i alla tre rutorna. I varje ruta går en blick bakåt eller åt sidan innan en
        ...
        med krysmönster, som ligger bakom och till höger i samma körfält; en streckad pil svänger
        av in i en sidoväg åt höger. Tredje och största rutan, före körfältsbyte, med tre numrerade
        ...
        manöver påbörjas, markerat med en bock; till höger finns bara spegellinjen som tar slut,
        den streckade pilen går ut i vänster körfält och ytan bilen styr in i, rakt framför
        cyklisten, är krysskrafferad, markerat med ett kryss.
      </desc>
      ...
      <defs>
        ...
        <marker id="sr-arrow-move" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="12" markerHeight="12" markerUnits="userSpaceOnUse" orient="auto">
          <path d="M 0 0 L 10 5 L 0 10 z" className="fill-primary-600" />
        </marker>
        <marker id="sr-arrow-plan" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="13" markerHeight="13" markerUnits="userSpaceOnUse" orient="auto">
          <path d="M 0 0 L 10 5 L 0 10 z" className="fill-attention-600" />
        </marker>
        <marker id="sr-arrow-look" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="11" markerHeight="11" markerUnits="userSpaceOnUse" orient="auto">
      ...
      {/* Teckenförklaring */}
      <g>
        <rect x="20" y="71" width="22" height="14" rx="2" fill="url(#sr-dots)" className="stroke-attention-600" strokeWidth="1.5" />
        <text x="50" y="83" className="fill-text-secondary text-[14px]">
          Du
        </text>
        <rect x="232" y="71" width="22" height="14" rx="2" fill="url(#sr-cross)" className="stroke-safety-600" strokeWidth="1.5" />
        <text x="262" y="83" className="fill-text-secondary text-[14px]">
          Cyklist
        </text>
        <rect x="330" y="71" width="22" height="14" rx="2" fill="url(#sr-stripes)" className="stroke-primary-600" strokeWidth="1.5" />
        <text x="360" y="83" className="fill-text-secondary text-[14px]">
          Annan bil
        </text>

        <line x1="32" y1="106" x2="48" y2="106" className="stroke-progress-600" strokeWidth="2.5" markerEnd="url(#sr-arrow-look)" />
        <Eye x={26} y={106} />
        ...
        <path d="M 20 130 L 46 130" className="stroke-attention-600" strokeWidth="3" strokeDasharray="8 6" markerEnd="url(#sr-arrow-plan)" />
        <text x="60" y="135" className="fill-text-secondary text-[14px]">
          Manövern — efter blicken
        </text>
        <path d="M 232 130 L 254 130" className="stroke-primary-600" strokeWidth="3" markerEnd="url(#sr-arrow-move)" />
      ...
      <rect x="20" y="144" width="400" height="186" rx="6" className="fill-none stroke-border-default" strokeWidth="1.5" />
      <Road y={152} height={170} />
      <text x="20" y="176" className="fill-text-primary text-[15px] font-semibold">
        Före fartändring
      </text>

      <path d="M 334 190 L 334 164" className="stroke-attention-600" strokeWidth="4" strokeDasharray="10 8" markerEnd="url(#sr-arrow-plan)" />
      <Car cx={334} cy={216} width={26} length={44} fill="url(#sr-dots)" stroke="stroke-attention-600" />
      <Eye x={334} y={246} />
      <LookLine x1={334} y1={252} x2={334} y2={270} />
      <line x1="352" y1="272" x2="352" y2="254" className="stroke-primary-600" strokeWidth="3" markerEnd="url(#sr-arrow-move)" />
      <Car cx={334} cy={296} width={26} length={44} fill="url(#sr-stripes)" stroke="stroke-primary-600" />
      ...
      <rect x="20" y="340" width="400" height="208" rx="6" className="fill-none stroke-border-default" strokeWidth="1.5" />
      ...
      <path
        ...
        markerEnd="url(#sr-arrow-plan)"
      />
      <Car cx={334} cy={468} width={26} length={44} fill="url(#sr-dots)" stroke="stroke-attention-600" />
      <Eye x={356} y={452} />
      <LookLine x1={355} y1={460} x2={353} y2={505} />
      <line x1="341" y1="508" x2="341" y2="497" className="stroke-primary-600" strokeWidth="3" markerEnd="url(#sr-arrow-move)" />
      ...
      <rect x="20" y="558" width="400" height="318" rx="6" className="fill-none stroke-border-default" strokeWidth="1.5" />
      ...
      <path
        ...
        markerEnd="url(#sr-arrow-plan)"
      />
      <Car cx={334} cy={690} width={26} length={44} fill="url(#sr-dots)" stroke="stroke-attention-600" />
      <LookLine x1={314} y1={672} x2={302} y2={696} stop w={3} />
      <LeftBlinker x={318} y={704} flash />
      <LookLine x1={321} y1={722} x2={287} y2={755} />
      <Eye x={326} y={724} />
      <line x1="278" y1="742" x2="278" y2="724" className="stroke-primary-600" strokeWidth="3" markerEnd="url(#sr-arrow-move)" />
      ...
      <Pointer x1={150} y1={668} x2={300} y2={698} />
      ...
      <Pointer x1={150} y1={734} x2={310} y2={706} />
      ...
      {/* Vad bilden lär ut */}
      <text x="220" y="902" textAnchor="middle" className="fill-text-primary text-[14px] font-medium">
        Spegeln hör ihop med en manöver — och kommer före den.
      </text>
      <text x="220" y="920" textAnchor="middle" className="fill-text-primary text-[14px] font-medium">
        Vid körfältsbyte: spegel, tecken, axelblick, i den ordningen.
      </text>

      {/* Förklaringsruta */}
      <rect x="20" y="936" width="400" height="222" rx="6" className="fill-none stroke-border-default" strokeWidth="1.5" />
      <text x="34" y="960" className="fill-text-primary text-[14px] font-semibold">
        Vad axelblicken avgör:
      </text>
      <line x1="220" y1="974" x2="220" y2="1146" className="stroke-border-default" strokeWidth="1.5" strokeDasharray="6 4" />

      <MiniByte x={118} y={1030} variant="axelblick" />
      <text x="118" y="1098" textAnchor="middle" className="fill-text-primary text-[14px] font-semibold">
        Axelblicken görs
      </text>
      ...
      <text x="322" y="1098" textAnchor="middle" className="fill-text-primary text-[14px] font-semibold">
