 ...
 *   Ratten på duken: mitt (221, 174), radie 39 → x 182–260, y 135–213.
 *   Pedalen på duken: x 169–182, y 246–268. Vänstermarginalens text slutar
 *     vid x 150, alltså rör ingen etikett scenen.
 *   1 knä (249, 215) — pekare (150, 246) → (245, 216). Hela pekaren ligger i
 *     y 216–246, alltså under rattens underkant 213, och den startar till
 *     höger om rubriktexten som slutar vid x 140.
 *   2 armbåge (280,8 | 160,2) — pekare (200, 118) → (276, 157). Närmaste
 *     avstånd till rattens mitt är 45,2 (vid x 221), alltså utanför radien 39.
 *   3 nackstödet (370, 112) — pekare (400, 140) → (370, 112), enda pekaren i
 *     höger marginal. Nackstödet på duken: x 350–370, y 84–133, och höger
 *     etikettspalt börjar på x 384 — 14 px fri marginal.
 *   Vänster: inredningens vänsterkant är lokal x 72, alltså duk-x 154, medan
 *     vänsterspaltens längsta rad slutar vid x 140.
 *   Pekare 1 (y 216–246) och pekare 2 (y 118–157) överlappar inte i y.
 *   Pekare 3 (x 370–400) och pekare 2 (x 200–276) överlappar inte i x.
 ...
 * samma fasta ratt, pedal och golv. Panel A translate(46 492), panel B
 * translate(276 492); innehållet är 178 × 146 → A x 46–224 y 492–638,
 * B x 276–454 y 492–638. Avdelaren står på x 250: 224 < 250 < 276, alltså
 * rör ingen panel den, och den slutar på y 722 medan slutraden står på
 * y 744.
...
function Inredning() {
  return (
    <g>
      {/* Golv */}
      <line x1="72" y1={GOLV} x2="300" y2={GOLV} className="stroke-text-tertiary" strokeWidth="3" />
      {/* Torpedvägg framför fötterna */}
      <line x1="72" y1={GOLV} x2="72" y2="248" className="stroke-text-tertiary" strokeWidth="3" />
      {/* Instrumentbräda */}
      <polygon
        points="72,248 104,258 104,284 72,300"
        className="fill-neutral-200 stroke-text-tertiary"
        strokeWidth="2"
      />
      {/* Rattstång */}
      <line x1="104" y1="272" x2="139" y2="268" className="stroke-text-primary" strokeWidth="6" />
      ...
      <line
        ...
        strokeLinecap="round"
      />
      <line x1="87" y1="340" x2="76" y2="335" className="stroke-text-tertiary" strokeWidth="3" />
    </g>
  );
}
...
function Stol({ dx }: { dx: number }) {
  return (
    ...
    >
      ...
      <polygon points="250,324 262,230 286,233 276,327" />
  ...
  return (
    <g>
      ...
      <circle
        ...
        cy={HANDLED[1]}
        r="7"
        className="fill-surface-base stroke-attention-600"
        strokeWidth="3"
      />
...
export function ForarstallningDiagram() {
  return (
    ...
    >
      <title id="fs-title">
        Förarställning: lätt böjda leder vid pedal och ratt, nackstödet i öronhöjd
      </title>
      <desc id="fs-desc">
        Sidovy av en förare i förarsätet, sedd rakt genom förardörren. Bilens front pekar åt
        vänster: längst till vänster syns golvet, torpedväggen, instrumentbrädan som en grå kil och
        pedalen som ett kraftigt streck; i mitten ratten, ritad som en ring sedd i profil med ett
        nav; till höger stolen med dyna, lutat ryggstöd och nackstöd, allt i ljusgrått med mörk
        kontur. Föraren är ritad med kraftiga blå streck för bål, ben och arm, med vita cirklar med
        blå kontur för huvudet och för handen om rattens krans. En liten ring i huvudet markerar
        örat. Vid armbågen och vid knäet ligger var sin grön båge som visar ledvinkeln; båda bågarna
        är tydligt krökta, alltså är leden böjd och inte rak. Handen ligger på kransen så att
        handleden hamnar i höjd med rattens överkant. En streckad linje med ett lodrätt ändstreck i
        var ände går vågrätt från örat bakåt till nackstödet och visar att nackstödets mitt ligger
        på samma höjd som örat; samma streckade linje med ändstreck används inte till något annat i
        bilden. Tre numrerade hänvisningar med tunna linjer och en punkt i målet: 1 pekar på knäet,
        2 på armbågen, 3 på nackstödet. Längst ned en ruta med två paneler sida vid sida, i samma
        skala och med ratt, pedal och golv på exakt samma plats. Till vänster, märkt med en grön
        bock och ordet Rätt: stolen står så att både armbågens och knäets bågar är krökta. Till
        höger, märkt med ett rött kryss och ordet Fel: stolen står en bit längre bak, och då är båda
        bågarna nästan platta — armen och benet är utsträckta. Skillnaden mellan panelerna syns i
        bågarnas form, inte i stolens läge, som bara flyttats en liten bit.
      </desc>
      ...
      <g transform="translate(82 -94)">
        ...
        <g className="stroke-text-primary" strokeWidth="2">
          <line x1="258" y1="202.5" x2="288" y2="202.5" strokeDasharray="5 4" />
          <line x1="258" y1="194" x2="258" y2="211" />
          <line x1="288" y1="194" x2="288" y2="211" />
        </g>
      </g>

      {/* 1. Knäet */}
      <Callout x={24} y={246} n={1} />
      <text x="42" y="251" className="fill-text-primary text-[14px] font-semibold">
        Lätt böjt knä
      </text>
      <text x="12" y="274" className="fill-text-secondary text-[14px]">
        Foten når pedalen
      </text>
      <text x="12" y="292" className="fill-text-secondary text-[14px]">
        utan att benet
      </text>
      <text x="12" y="310" className="fill-text-secondary text-[14px]">
        sträcks rakt
      </text>
      <Pekare x1={150} y1={246} x2={245} y2={216} />
      ...
      <Pekare x1={200} y1={118} x2={276} y2={157} />

      {/* 3. Nackstödet */}
      <Callout x={396} y={74} n={3} />
      <text x="414" y="79" className="fill-text-primary text-[14px] font-semibold">
        Nackstödet
      </text>
      <text x="384" y="102" className="fill-text-secondary text-[14px]">
        med mitten i
      </text>
      <text x="384" y="120" className="fill-text-secondary text-[14px]">
        höjd med örat
      </text>
      <Pekare x1={400} y1={140} x2={370} y2={112} />

      {/* Teckenförklaring, i den fria högermarginalen under hänvisning 3 */}
      <g>
        <path
          d="M 386 216 A 20 20 0 0 1 410 198"
          className="fill-none stroke-progress-600"
          strokeWidth="4"
          strokeLinecap="round"
        />
        <text x="384" y="240" className="fill-text-secondary text-[14px]">
          Bågen visar hur
        </text>
        <text x="384" y="258" className="fill-text-secondary text-[14px]">
          böjd leden är
        </text>
        <g className="stroke-text-primary" strokeWidth="2">
          <line x1="386" y1="290" x2="410" y2="290" strokeDasharray="5 4" />
          <line x1="386" y1="283" x2="386" y2="297" />
          <line x1="410" y1="283" x2="410" y2="297" />
        </g>
        <text x="384" y="316" className="fill-text-secondary text-[14px]">
          Samma höjd
        </text>
      </g>
      ...
      <text x="250" y="392" textAnchor="middle" className="fill-text-secondary text-[14px]">
      ...
      <rect
        ...
        strokeWidth="1.5"
      />
      <text x="34" y="442" className="fill-text-primary text-[14px] font-semibold">
      ...
      {/* Rätt */}
      <path
        d="M 54 474 L 60 481 L 72 466"
        className="fill-none stroke-progress-600"
        strokeWidth="4"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <text x="80" y="480" className="fill-text-primary text-[14px] font-semibold">
        Rätt
      </text>
      <MiniStallning x={46} y={492} hoftX={232} variant="ratt" />
      <text
        x="135"
        y="660"
        textAnchor="middle"
      ...
      <text x="135" y="680" textAnchor="middle" className="fill-text-secondary text-[14px]">
        Ratten går lätt att
      </text>
      <text x="135" y="698" textAnchor="middle" className="fill-text-secondary text-[14px]">
        vrida, och du når
      </text>
      <text x="135" y="716" textAnchor="middle" className="fill-text-secondary text-[14px]">
        hela vägen runt
      </text>

      {/* Fel */}
      <g className="stroke-safety-600" strokeWidth="4" strokeLinecap="round">
        <line x1="282" y1="467" x2="296" y2="481" />
        <line x1="296" y1="467" x2="282" y2="481" />
      </g>
      <text x="306" y="480" className="fill-text-primary text-[14px] font-semibold">
        Fel — för långt bak
      </text>
      <MiniStallning x={276} y={492} hoftX={239.5} variant="fel" />
      <text
        x="365"
        y="660"
        textAnchor="middle"
      ...
      <text x="365" y="680" textAnchor="middle" className="fill-text-secondary text-[14px]">
        Ratten blir tung att
      </text>
      <text x="365" y="698" textAnchor="middle" className="fill-text-secondary text-[14px]">
        vrida, och benet
      </text>
      <text x="365" y="716" textAnchor="middle" className="fill-text-secondary text-[14px]">
        sträcks ut mot pedalen
      </text>

      <text x="250" y="744" textAnchor="middle" className="fill-text-tertiary text-[14px]">
